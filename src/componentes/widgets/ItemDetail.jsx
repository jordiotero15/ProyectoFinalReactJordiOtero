...
//                             <Link onClick={() => carrito(producto)} className='bg-blue-500 text-white hover:bg-blue-600 text-lg font-bold transition-all duration-500 h-10 pt-1 rounded text-center' to="/cart">Comprar ahora</Link>
//                             <button onClick={() => carrito(producto)} className='text-blue-500 text-lg font-bold h-10 border-2 rounded active:border-blue-500'>Agregar al carrito</button>
//                         </div>
//                         <div className=''>
